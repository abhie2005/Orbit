...
| Landing hero uses the recursive-erosion field | The original static seven-node SVG is replaced by a native-canvas sphere of rotating amber particles with procedural molten erosion bands. It is deterministic, responsive, dependency-free, and freezes to a representative frame when reduced motion is requested. |
