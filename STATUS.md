...
| Landing hero uses the recursive-erosion field | The original static seven-node SVG is replaced by the isolated particle-sphere visual in `components/ui/recursive-erosion.tsx`, framed in Orbit's square brutalist treatment and embedded with a descriptive iframe title. |
